...
class StarWarsViewModel(
    ...
    private fun setTiempo(tiempo: Int) {
        // Es Run Latter porque al ser una variable Reactiva y yo estar en un hilo
        // distinto al de la interfaz, tengo que hacerlo asi para que se actualice en el hilo IU
        Platform.runLater {
    ...
    private fun report(): String {
        ...
        sb.append("Procentaje de aciertos: ${(state.aciertos.value * 100) / state.disparos.value} %\n")
    ...
    data class StarWarsState(
        ...
        val resultado: SimpleObjectProperty<com.github.michaelbull.result.Result<StarWarsResultado, StarWarsError>> = SimpleObjectProperty(
